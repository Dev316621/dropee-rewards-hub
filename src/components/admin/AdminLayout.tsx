...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Activity, label: "Agent Tracking", path: "/admin/agent-tracking" },
...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <aside
        className={cn(
          "hidden md:flex flex-col border-r bg-card sticky top-0 h-screen transition-all duration-200",
          collapsed ? "w-16" : "w-56"
        )}
      >
        {/* Logo */}
        <div className="p-3 border-b flex items-center justify-between">
          <Link to="/admin" className="flex items-center gap-2">
            ...
            {!collapsed && (
              <div>
                <span className="text-sm font-bold font-display">DROPEE</span>
      ...
      {/* Content */}
      <main className="flex-1 md:p-6 p-4 pt-20 pb-20 md:pt-6 md:pb-6 overflow-auto min-h-screen">
        <Outlet />
      </main>
