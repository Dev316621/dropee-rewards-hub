...
import { ShoppingCart, Plus, Minus, Trash2, Package, ArrowRight, CheckCircle, Search, ShoppingBag, X } from "lucide-react";
...
const Shop = () => {
  ...
  const addToCart = (product: any) => {
    setCart(prev => {
      ...
      return [...prev, { id: product.id, name: product.name, price: Number(product.price), image_url: product.image_url, qty: 1, product_type: product.product_type }];
    });
  ...
  return (
    <>
      <SEOHead title="Shop" description="Browse and shop products at DROPEE — physical goods and digital items delivered to you." path="/shop" />
      ...
      <section className="hero-section py-12 sm:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-sm sm:text-lg text-primary-foreground/70">Browse products & place orders</p>
        </div>
      </section>
          ...
          {cart.length > 0 && (
            <div className="border-t pt-3 space-y-3">
              <div className="flex justify-between font-semibold">
                <span>Total</span>
                <span className="text-primary font-display">₹{cartTotal}</span>
              </div>
              {user ? (
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input placeholder="Your delivery address" value={address} onChange={e => setAddress(e.target.value)} />
            </div>
            <div className="space-y-2">
              <Label>Phone</Label>
            ...
            <div className="space-y-2">
              ...
              <Textarea placeholder="Special instructions..." value={orderNotes} onChange={e => setOrderNotes(e.target.value)} rows={2} />
            </div>
